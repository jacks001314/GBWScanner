...
public class Test {
    ...
    private static void uploadFile(FileSystem fs, String fileSrcPath,
                            String fileDstPath) throws IOException {

        Path dst = new Path("/tmp/test", fileDstPath);
    ...
    public static void main(String[] args) throws IOException, YarnException, InterruptedException {
        ...
        yarnConf.set("fs.defaultFS","hdfs://101.124.62.41:8020");
        //YarnClient client = YarnClient.createYarnClient();

        uploadFile(FileSystem.get(yarnConf),"D:\\shajf_dev\\GBWScanner\\src\\main\\java\\com\\gbw\\scanner\\plugins\\scripts\\hadoop\\Test.data",
                "data1");
        /*
