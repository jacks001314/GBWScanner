...
public class ByteDataUtils {
    ...
    public static String toHex(BigInteger bigInt,boolean isLittle){
    ...
    public static BigInteger toBigInt(byte[] bytes,boolean isLittle,boolean isPositive){
    ...
    public static BigInteger toBigInt(String hex,boolean isLittle,boolean isPositive){

        byte[] data = parseHex(hex);

        return toBigInt(data,isLittle,isPositive);
    }

    public static BigInteger toBigInt(String hex,int n,boolean isLittle,boolean isPositive){
        ...
        return toBigInt(sb.toString(),isLittle,isPositive);
    }
